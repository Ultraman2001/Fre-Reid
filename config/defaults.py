...
_C.MODEL.OSNET_FUSION.FUSION_TYPE = 'descriptor'  # descriptor / fdmf / dwt_fdmf
_C.MODEL.OSNET_FUSION.FUSION_NORM = 'none'  # none / branch / weighted_branch; fdmf uses none
_C.MODEL.OSNET_FUSION.FUSION_BETA = 1.0     # OSNet branch scale for weighted_branch
_C.MODEL.OSNET_FUSION.FDMF_COMPRESSED_CHANNELS = 64
_C.MODEL.OSNET_FUSION.FDMF_LOWPASS_KERNEL = 5
_C.MODEL.OSNET_FUSION.FDMF_HIGHPASS_KERNEL = 3
_C.MODEL.OSNET_FUSION.FDMF_HAMMING_WINDOW = True
_C.MODEL.OSNET_FUSION.FDMF_FILTER_TYPE = 'dynamic'  # dynamic / fixed
...
_C.MODEL.OSNET_FUSION.DWT_RESIDUAL_INIT = 0.1
_C.MODEL.OSNET_FUSION.DWT_HIGH_GATE = True
