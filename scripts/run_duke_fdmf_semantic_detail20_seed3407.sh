...
OUTPUT_BASE="${OUTPUT_BASE:-./logs/Duke/fdmf_semantic_detail20_seed3407}"
...
SUMMARY_NAME="${SUMMARY_NAME:-summary_s3407.txt}"
...
# Strict no-local control plus the top 4 seed=42 experiments, re-run with seed=3407.
# Run only the missing control with:
#   MODE=all EXPERIMENT_FILTER=sd20_nolocal_s3407 \
#   SUMMARY_NAME=summary_nolocal_s3407.txt \
#     bash scripts/run_duke_fdmf_semantic_detail20_seed3407.sh 0 1
#
# 1. sd20_s3_s3g_o4: mAP=84.7 R1=92.2 (best mAP)
# 2. sd20_s3_ng_o4:   mAP=84.7 R1=91.4
# 3. sd20_s4_s4g_o2:  mAP=84.5 R1=92.3 (best R1)
# 4. sd20_hybrid_k3:  mAP=84.5 R1=91.9
